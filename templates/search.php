  ...
  <div class="header-results hidden">
    ...
    <ul class="header-results__list">
      <li class="header-results__item">
          <a href="#" class="header-results__link">
              <div class="header-results__img-box">
                  <img class="header-results__img" src="<?= get_template_directory_uri(  ); ?>/assets/img/card-1.jpg" alt="">
              </div>
      ...
      <li class="header-results__item">
          <a href="#" class="header-results__link">
              <div class="header-results__img-box">
                  <img class="header-results__img" src="<?= get_template_directory_uri(  ); ?>/assets/img/card-3.jpg" alt="">
              </div>
              <div class="header-results__text-box">
                  <p class="header-results__text">
                      Вебинар
      ...
      <li class="header-results__item">
          <a href="#" class="header-results__link">
              <div class="header-results__img-box">
                  <img class="header-results__img" src="<?= get_template_directory_uri(  ); ?>/assets/img/card-5.jpg" alt="">
              </div>
              <div class="header-results__text-box">
                  <p class="header-results__text">
                      Лекция
