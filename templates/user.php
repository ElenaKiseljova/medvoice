    ...
    <div class="header-profile__menu hidden">
        <ul class="header-profile__list">
            <li class="header-profile__item">
              <a class="header-profile__item-link" href="<?= medvoice_get_special_page( 'bookmarks', 'url' ); ?>?user=<?= $medvoice_user->ID; ?>">
            ...
            <li class="header-profile__item">
              <a class="header-profile__item-link" href="<?= medvoice_get_special_page( 'profile', 'url' ); ?>?user=<?= $medvoice_user->ID; ?>">
                <svg class="header-profile__icon" width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
...
<?php else: ?>
  <div class="header__guest-mode">
    <a href="<?= medvoice_get_special_page( 'forms', 'url'  ); ?>?action=trial" class="button button--subscribe"><?= __( 'Оформить подписку', 'medvoice' ); ?></a>
